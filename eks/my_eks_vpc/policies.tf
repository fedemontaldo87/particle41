...
# https://computingforgeeks.com/enable-cluster-autoscaler-in-an-eks-cluster/
# https://katharharshal1.medium.com/kubernetes-cluster-autoscaling-ca-using-aws-eks-4aab8c89f9a1
resource "aws_iam_policy" "my_eks_cluster_autoscaler" {
  name        = "my_eks_cluster_autoscaler"
  path        = "/"
  description = "my_eks_cluster_autoscaler policy"
...
# https://kubernetes-sigs.github.io/aws-load-balancer-controller/guide/controller/installation/
# https://aws.amazon.com/pt/blogs/containers/introducing-aws-load-balancer-controller/
# https://docs.aws.amazon.com/eks/latest/userguide/alb-ingress.html
resource "aws_iam_policy" "my_eks_aws_lb_controller" {
  name        = "my_eks_aws_lb_controller"
  path        = "/"
  description = "my_eks_aws_lb_controller policy"
